...
class TestPiiUtilityFunctions(unittest.TestCase):
    @parameterized.expand([
        ...
        ["no_overlap", [
            {"start_pos": 12, "end_pos": 15}, {"start_pos": 6, "end_pos": 8}, {"start_pos": 1, "end_pos": 5}
        ], False],
        ["overlap_1", [
...
class TestMaskRecords(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        [
            ...
            [{"start_pos": 0, "end_pos": 8, "value": "5234 7894", "id": "2", "name": "CREDIT_CARD"}, ],
            1,
            False
        ],
        [
            ...
            [{"start_pos": 0, "end_pos": 7, "value": "52347894", "id": "2", "name": "DRIVER_LICENSE"}, ],
            1,
            False
        ],
    ])
