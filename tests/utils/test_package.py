...
class TestCalculateFilePath(unittest.TestCase):
    ...
    def test_calculate_file_paths_default(self):
        ...
        contamination_file, pii_file, propella_file, out_file = package._calculate_file_paths(
            src_file, self.src_dir, self.contamination_dir, self.pii_dir, self.propella_dir, self.output_dir, metadata
        )
    ...
    def test_calculate_file_paths_other_suffix(self):
        ...
        self.assertEqual(self.propella_dir.joinpath("shard01/file01.jsonl.gz"), propella_file)
        self.assertEqual(self.output_dir.joinpath("shard01/file01.jsonl.zst"), out_file)
